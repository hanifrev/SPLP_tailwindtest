...
export default function Fair1() {
  return (
    <div
      className="h-screen flex py-0 px-2 flex-col justify-start items-center bg-skyblue w-full sm:justify-center"
      style={{
    ...
    >
      ...
      <header className="flex flex-row absolute justify-between top-0 w-full px-3 pt-3 sm:top-6">
        ...
        <h1 className="text-base font-bold text-white sm:text-xl">Language</h1>
      </header>
      <content className="mx-auto flex-shrink w-11/12 pt-24 sm:pt-0 sm:w-11/12">
        <div className="flex flex-col sm:flex-row">
          ...
          <div className="w-full">
            <div className="flex w-full mx-auto">
              <img
                className="relative pl-0 sm:absolute sm:pl-20"
